...
![Ack DLLP](../images/图9-2.Ack_DLLP.jpg)
...
Data Link Layer                                    Data Link Layer
    |                                                  |
Physical Layer      Framing (SDP)  +0  +1  +2  +3   Physical Layer
    | (RX)  <----------------------+--+--+--+--+-->  | (TX)
                     | DLLP Type | 字段 (因DLLP类型而异) |
                     +-----------+---------------------+
                     Byte 0      Byte 4
...
+--------+--------+--------+--------+--------+--------+--------+--------+
| DLLP类型|  属性字段 (因类型而异)         | 16位CRC | 帧符号 |
+--------+----------------------------------+--------------------+--------+

注：在Gen3/128b/130b编码模式下，使用2字节SDP令牌替代SDP控制符号，且无END符号。
```
...
![Nak DLLP](../images/图9-3.Nak_DLLP.jpg)
...
+--------+--------+--------+--------+--------+--------+
| DLLP类型       | 保留   | AckNak_Seq_Num | 16位CRC        |
+--------+--------+--------+--------+--------+--------+
...
Byte:|       0                   |       1                   |       2                   |       3                   |
     +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+
     | 0  0  0  0  0  0  0  0  |  保留                     | 0  0  0  0  AckNak_Seq_Num[11:8] | AckNak_Seq_Num[7:0]  |
     +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+
     0000 0000b = Ack

     | 0  0  0  1  0  0  0  0  |  保留                     | 0  0  0  0  AckNak_Seq_Num[11:8] | AckNak_Seq_Num[7:0]  |
     +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+
     0001 0000b = Nak
...
Byte:|       4                   |       5                   |
     +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+
     |        16-bit CRC [15:8] |        16-bit CRC [7:0]   |
     +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+
```
...
Byte:|       0                   |       1                   |       2                   |       3                   |
     +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+
     | 0  0  1  0  0  x  x  x  |  保留                     |  保留                     |  保留                     |
     +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+
     0010 0xxxb (xxx根据具体类型变化)
...
| Byte 0 | Byte 1 | Byte 2 | Byte 3 | Byte 4 | Byte 5 |
+--------+--------+--------+--------+--------+--------+
| 类型/VC ID | HeaderFC             | DataFC         | 16位CRC        |
+--------+--------+--------+--------+--------+--------+
...
Byte:|       0                   |       1                   |       2                   |       3                   |
     +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+
     |类型[3:0]|0 | VC[2:0]     | HdrFC[5:0]                |HF[7:6]|R| DataFC[3:0]       | DataFC[11:4]            |
     +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+ | +--+--+--+--+--+--+--+--+
     | 类型编码   |0| VC ID     | 头部信用[5:0]             |头信用|保| 数据信用[3:0]     | 数据信用[11:4]          |
...
字段说明:
- 类型[3:0]: DLLP类型编码 (4位)
- 0: 必须为0b，作为流量控制编码的一部分
- VC[2:0]: 虚拟通道ID (3位，指示VC 0-7)
- HdrFC[7:0]: 头部流量控制信用 (8位)
  - Byte 1[5:0]: HdrFC[5:0] (低6位)
  - Byte 2[7:6]: HdrFC[7:6] (高2位)
- DataFC[11:0]: 数据流量控制信用 (12位)
  - Byte 2[3:0]: DataFC[3:0] (低4位)
  - Byte 3[7:0]: DataFC[11:4] (高8位)
- R: 保留位
```
